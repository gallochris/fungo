...
pb <- odds %>% 
  rvest::html_nodes('table') %>% 
  xml2::xml_find_all("//td[contains(@class, 'goto fd _fd odds-cell null')]") %>% 
  rvest::html_text()
...
This is a simple example pulling together markdown table of team's odds to make the NBA Championship. It pulls from [OddsBoom](https://www.oddsboom.com/nba/futures/22-nba-championship/) and selects the odds of a few sports books. 
